  ...
  return (
    <main className="px-4 md:px-section">
      ...
      <div className="my-block text-title md:w-8/12 text-faded mx-[0] md:mx-auto mb-block">
        <h2 className="text-title font-bold pb-2">Why Donate Us?</h2>
        <p className="text-sub-para">
          We are a non profit organization that is working hard to promote tech
          literacy and we don’t have any source of income and that is the very
          reason why we encourage you to donate us.
        </p>
      </div>
      <div className="my-block md:w-8/12 text-faded mx-[0] md:mx-auto mb-block">
        <h2 className="text-title font-bold pb-2">Donate us via</h2>
  ...
  return (
    <section className="mt-block">
      ...
      <div className="my-block text-title  text-faded mx-[0] md:mx-auto mb-block">
        <h2 className="text-title font-bold pb-2">How can you donate us?</h2>
        <p className="text-sub-para">
      ...
      <div className="my-block text-title  text-faded mx-[0] md:mx-auto mb-block">
        <h2 className="text-title font-bold pb-2">
      ...
      <form className="my-block text-title  text-faded mx-[0] md:mx-auto mb-block">
        <h2 className="text-title font-bold pb-2">Donation Information</h2>
        ...
        {/* -------ended  */}
        <div className="my-block text-title  text-faded mx-[0] md:mx-auto mb-block">
          <h2 className="text-title font-bold pb-2">Personal Information</h2>
          <div className="mb-2">
...
/* <InfoBanner
        leftContent={<div>Really</div>}
        rightContent={"yes"}
        CTALink={"/DONATESOMETHING"}
      /> */
