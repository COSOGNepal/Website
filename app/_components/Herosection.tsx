            ...
            <main className="relative top-0  flex z-10 w-full h-full">
                <div className="item1 absolute">
                    <div className="relative w-40 h-52  md:w-56 md:h-64 ">
                        <svg
                            ...
                            <g opacity="0.5">
                                <path fillRule="evenodd" clipRule="evenodd" d="M96.3412 145.2C96.3412 65.0083 161.555 0 242 0C322.445 0 387.659 65.0083 387.659 145.2V338.8C387.659 418.992 322.445 484 242 484C161.555 484 96.3412 418.992 96.3412 338.8V145.2ZM144.894 326.7C144.894 380.161 188.37 423.5 242 423.5C295.63 423.5 339.106 380.161 339.106 326.7V157.3C339.106 103.839 295.63 60.5 242 60.5C188.37 60.5 144.894 103.839 144.894 157.3V326.7Z" fill="url(#paint0_linear_486_5910)" />
                                <path fillRule="evenodd" clipRule="evenodd" d="M145.2 387.659C65.0083 387.659 0 322.445 0 242C0 161.555 65.0083 96.3412 145.2 96.3412H338.8C418.992 96.3412 484 161.555 484 242C484 322.445 418.992 387.659 338.8 387.659H145.2ZM326.7 339.106C380.161 339.106 423.5 295.63 423.5 242C423.5 188.37 380.161 144.894 326.7 144.894L157.3 144.894C103.839 144.894 60.5 188.37 60.5 242C60.5 295.63 103.839 339.106 157.3 339.106H326.7Z" fill="url(#paint1_linear_486_5910)" />
                            </g>
                            <defs>
                                <linearGradient id="paint0_linear_486_5910" x1="241.998" y1="179.255" x2="211.809" y2="489.48" gradientUnits="userSpaceOnUse">
                                    <stop stopColor="#FFCACA" />
                                    <stop offset="1" stopColor="#CED8E1" />
                                </linearGradient>
                                <linearGradient id="paint1_linear_486_5910" x1="-28.673" y1="387.659" x2="413.585" y2="139.073" gradientUnits="userSpaceOnUse">
                ...
                <div className="item2 absolute -bottom-20 left-1/2 -translate-x-1/2">
                    <div className="relative w-52 h-64  md:w-72 md:h-96 ">
                        ...
                        >
                            <path fillRule="evenodd" clipRule="evenodd" d="M154.157 0L0 143L136.231 269.371L172.083 236.114L71.7038 143L154.157 66.5142L236.611 143L215 163.047L175.463 126.371L139.611 159.629L275.843 286L430 143L275.843 0L215 56.4392L154.157 0ZM250.852 89.6963L308.315 143L250.852 196.304L275.843 219.486L358.296 143L275.843 66.5142L250.852 89.6963Z" fill="url(#paint0_linear_486_5921)" />
                            <defs>
                                <linearGradient id="paint0_linear_486_5921" x1="338.5" y1="-182" x2="-205.5" y2="515.5" gradientUnits="userSpaceOnUse">
