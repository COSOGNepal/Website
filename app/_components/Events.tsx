        ...
        <main className="px-block w-screen mx-auto space-y-block">
            ...
            <section className="w-full max-w-[1400px] mx-auto grid grid-cols-auto-fit-600 grid-rows-2-400 gap-small justify-center">
                {EventsData.map((event, index) => (
                    ...
                    >
                        <div className="absolute text-white px-8 pb-2 md:pb-6 bottom-0  w-full bg-gradient-to-t from-[rgba(0,0,0,0.8)] group-hover:from-30% flex justify-end flex-col"> <span className="text-info font-medium">
                            {event.date}
                        </span>
